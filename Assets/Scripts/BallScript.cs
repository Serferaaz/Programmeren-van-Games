...
public class BallScript : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D other){
        if (other.transform.CompareTag("Brick")) {
            ...
            // Hier zeg je dus dat je naar het object moet gaan wat je zojuist hebt geraakt en pak daarvan het script. Ga in het script en pak dan de waarde van de punten.
