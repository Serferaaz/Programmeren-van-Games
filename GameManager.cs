...
public class GameManager : MonoBehaviour
{
    ...
    void Start() {
        // Hier geef je aan wat de teksten moeten zijn en met welk variabele ze te werk moeten gaan om een werkend onderdeel te krijgen.
        // Bij Lives krijg je door de " + lives" te zien hoeveel levens je hebt naast de tekst " Livens". Hetzelfde geld voor de Score.
        // Daarnaast kijk je hoeveel bricks je hebt en dat doe je door middel de FindGameObjectsWithTag (" Brick).Length. Want alle bricks hebben een tag genaamd "Brick"
    ...
    // Hier laadt je het volgende level.
    void LoadingLevels() {
        currentLevel++;
